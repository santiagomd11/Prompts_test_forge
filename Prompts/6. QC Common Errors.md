...
├── container_output/                # (optional) Contains results from review command execution
...
|---|---|---|---|
| 10a | `overspecifiedTests` | Tests assert values the agent can't know | HIGH |
| 10b | `underspecifiedDocumentation` | PS/Reqs missing info that tests depend on | HIGH |
| 10c | `documentationTestMismatch` | PS/Reqs say X, tests expect Y | HIGH |
...
- Container output vs task directory mismatch (containerOutputMismatch)
