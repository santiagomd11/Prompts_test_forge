...
2. **Constants and Variables**: Non-callable exports
3. **Type Definitions**: Type aliases, interfaces, enums (TypeScript `type`, `interface`)
4. **Re-exports**: Simple forwarding exports
